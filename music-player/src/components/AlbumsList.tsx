...
import {Avatar, Box, CircularProgress, Divider, List, ListItem, ListItemAvatar, ListItemButton, ListItemText, ListSubheader} from '@mui/material';
                        ...
                        <React.Fragment key={i}>
                            <ListItem disablePadding>
                                <ListItemButton onClick={() => setSelectedAlbum(albumData)}>
                                    ...
                                    <ListItemText primary={albumData.name}/>
                                </ListItemButton>
                            </ListItem>
                            <Divider/>
                        </React.Fragment>
